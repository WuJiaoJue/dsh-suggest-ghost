...
/** 会话日志事件名。 */
export declare const SUGGEST_EVENT: "suggest-ghost/suggested";
export declare const REQUEST_EVENT: "suggest-ghost/request";
export declare const HOT_INDEX_EVENT: "suggest-ghost/hot-index";
/** 投影单元名（client 通过 useProjection / faceOf 读取）。 */
export declare const PROJECTION_KEY: "suggestGhost";
