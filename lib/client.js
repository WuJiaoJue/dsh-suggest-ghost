...
function KeyField({ id, value, disabled, onChange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...
      children: capturing ? "\u6309\u4E0B\u7EC4\u5408\u952E\u2026\uFF08Esc \u53D6\u6D88\uFF09" : value === "" ? "\u70B9\u51FB\u8BBE\u7F6E\u5FEB\u6377\u952E" : value
    }
  );
}
function SuggestGhostCard({ scope }) {
  ...
  const renderField = (f) => {
    ...
    const control = f.kind === "boolean" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "true", children: "\u5F00\u542F" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "false", children: "\u5173\u95ED" })
        ]
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sgc-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sgc-fieldHead", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "sgc-label", htmlFor: `sgc-field-${f.key}`, children: f.label }) }),
      control,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: invalid ? "sgc-invalid" : "sgc-hint", children: invalid ? "\u8BF7\u8F93\u5165\u6570\u5B57" : f.hint })
    ] }, f.key);
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: open ? "sgc-card sgc-cardOpen" : "sgc-card", children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "sgc-headText", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "sgc-description", children: "\u8F93\u5165\u9884\u6D4B\uFF1A\u5386\u53F2\u524D\u7F00\u8865\u5168 + LLM \u4E0B\u4E00\u6761\u5EFA\u8BAE\uFF08\u8349\u7A3F\u4E3A\u7A7A\u65F6\uFF09\u3002\u6539\u52A8\u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\u3002" })
          ] }),
          isDirty && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "sgc-pending", children: "\u672A\u4FDD\u5B58" }),
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sgc-body", children: [
      !writable && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "sgc-readOnly", children: "\u5F53\u524D\u90E8\u7F72\u4E0D\u53EF\u5199\uFF08\u5185\u5B58\u6A21\u5F0F\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sgc-section", children: "LLM \u4E0B\u4E00\u6761\u5EFA\u8BAE" }),
      llmFields.map(renderField),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sgc-section", children: "\u5386\u53F2\u524D\u7F00\u8865\u5168" }),
      historyFields.map(renderField),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "sgc-footer", children: [
        saved && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "sgc-status", role: "status", children: "\u5DF2\u4FDD\u5B58" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "sgc-discard", disabled: !isDirty || busy, onClick: discard, children: "\u653E\u5F03\u4FEE\u6539" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "sgc-save", disabled: !writable || busy || !isDirty || anyInvalid, onClick: () => void save(), children: busy ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58" })
      ] })
    ] })
  ] });
}
