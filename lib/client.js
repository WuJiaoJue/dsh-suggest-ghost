...
function apply(ctx) {
  ...
  if (settingsScope !== void 0) {
    ...
    const applySettings = () => {
      ...
      settings = {
        ...
        history: Array.isArray(pushed?.history) ? (pushed?.history).filter((t) => typeof t === "string") : [],
  ...
  ctx.effect(() => {
    ...
    rebind();
    render();
    if (lastSessionId !== void 0) pullHistory(lastSessionId);
    if (lastSessionId !== void 0) pullHistory(lastSessionId);
    const onList = () => {
      const id = sessions.list.getSnapshot().current;
      if (id !== lastSessionId) {
        rebind();
        if (id !== void 0) pullHistory(id);
      }
      render();
    };
