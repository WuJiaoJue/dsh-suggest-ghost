...
import { cleanSuggestion, hasCJK, redactSecrets, sanitizeSuggestion, shouldFilterSuggestion, } from './sanitize.js';
/** 本能力所属的辅助请求超时错误码。 */
 ...
 */
export function buildTranscript(session, maxRecentTurns, maxTranscriptChars) {
